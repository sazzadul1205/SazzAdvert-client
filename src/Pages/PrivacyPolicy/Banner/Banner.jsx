...
const Banner = () => {
  ...
  const {
    data: PrivacyPolicyBanner,
    isLoading,
    isError,
  } = useQuery({
    queryKey: ["PrivacyPolicyBanner"],
    queryFn: async () => {
      ...
      <div className="flex justify-between max-w-[1200px] mx-auto  pt-52 items-center gap-5">
        ...
        <div className="text-black w-[535px]">
          <p className="text-lg mb-4 font-semibold">
            {PrivacyPolicyBanner.title}
          </p>
          <h1 className="text-[34px] font-bold mb-6">
            {PrivacyPolicyBanner.description}
          </h1>
          <h1 className="text-[16px] mb-12">{PrivacyPolicyBanner.content}</h1>
          <NavLink to={"/AboutUs"}>
        ...
        <div className="relative w-[522px] h-[365px]">
          ...
          <img
            src={PrivacyPolicyBanner.imageUrl}
            alt={PrivacyPolicyBanner.description}
