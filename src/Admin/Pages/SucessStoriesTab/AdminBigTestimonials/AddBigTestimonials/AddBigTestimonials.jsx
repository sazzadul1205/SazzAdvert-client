...
const AddBigTestimonials = ({ onClose, onSuccess }) => {
  const axiosPublic = useAxiosPublic();
  const { register, handleSubmit, reset } = useForm();

  const onSubmit = async (data) => {
    try {
      const response = await axiosPublic.post(`/BigTestimonials`, data);
...
export default AddBigTestimonials;

AddBigTestimonials.propTypes = {
