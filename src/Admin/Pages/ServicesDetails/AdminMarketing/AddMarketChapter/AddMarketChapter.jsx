...
const AddMarketChapter = ({ onClose, onSuccess }) => {
  const axiosPublic = useAxiosPublic();
  const { register, handleSubmit, reset } = useForm();

  const onSubmit = async (data) => {
    try {
      const response = await axiosPublic.post(`/MarketChapters`, data);
...
export default AddMarketChapter;

AddMarketChapter.propTypes = {
